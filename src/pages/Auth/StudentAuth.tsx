...
const StudentAuth: React.FC = () => {
  ...
  if (otpSent) {
    return (
      <AuthLayout
        ...
        image="/images/student-auth-bg.jpg"
      >
        <OtpVerification />
      </AuthLayout>
    );
  ...
  return (
    <AuthLayout
      title={tabValue === 0 ? "Welcome Back!" : "Create Account"}
      subtitle={tabValue === 0 ? "Login to access your dashboard and lessons." : "Join us and start your learning journey."}
      image="/images/student-auth-bg.jpg"
    >
